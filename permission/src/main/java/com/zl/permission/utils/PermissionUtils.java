package com.zl.permission.utils;
...
import com.zl.permission.menu.DefaultStartSettins;
import com.zl.permission.menu.IMenu;
import com.zl.permission.menu.OPPOStartSettings;
import com.zl.permission.menu.VIVOStartSettings;
...
public class PermissionUtils {
    ...
    //专门去回调MainActivity（被@PermissionCancel/PermissionDenied）的函数
   ...
   //跳转到设置界面
    public static void startAndroidSettings(Context context){
        ...
        try {
            ...
            Intent intent = iMenu.getStartActivity(context);
            if (intent != null) {
